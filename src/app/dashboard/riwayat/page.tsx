...
function Sidebar() {
  return (
    <aside className="fixed left-0 top-0 z-50 flex h-screen w-[238px] flex-col bg-[#020719] text-white">

      {/* LOGO */}
      <div className="flex h-[94px] items-center border-b border-white/10 px-6">
        <Link
          href="/dashboard"
...
export default async function RiwayatPage() {
  ...
  if (!customer) {
    return (
      <div className="min-h-screen bg-[#f8fafc]">
        ...
        <main className="ml-[238px] min-h-screen p-10">
  ...
  const totalNilaiBooking = bookings.reduce(
    (total, booking) => {
      ...
      return total + booking.lapangan.price * durasi;
    },
    0
  );
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc]">
      ...
      {/* KONTEN UTAMA */}
      <main className="ml-[238px] min-h-screen px-6 py-8 lg:px-10">
              ...
              <div className="flex flex-col justify-between gap-3 md:flex-row md:items-center">
                <div>
                  ...
                  <p className="mt-2 text-2xl font-bold text-slate-950">
                    {formatRupiah(totalNilaiBooking)}
                  </p>
                </div>
          ...
          {bookings.length === 0 ? (
            <div className="rounded-2xl border border-slate-200 bg-white px-6 py-16 text-center shadow-sm">
              ...
              <p className="mx-auto mt-3 max-w-md text-slate-500">
                Kamu belum melakukan pemesanan lapangan. Silakan pilih
                lapangan favoritmu dan mulai bermain.
              </p>
            ...
            <div className="space-y-6">
              ...
              {bookings.map((booking) => {
                ...
                const totalHarga =
                  booking.lapangan.price * durasiJam;
                        ...
                        <div className="rounded-2xl bg-slate-50 p-6">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <span className="font-semibold text-slate-900">
                              {formatRupiah(booking.lapangan.price)}
                            </span>
                          </div>
                          ...
                          <StatusPembayaran status={booking.status} />
                          ...
                          {booking.status === "CONFIRMED" && (
                            <div className="mt-4 rounded-xl border border-emerald-100 bg-emerald-50 p-4">
                              ...
                              <p className="mt-2 text-xs leading-5 text-emerald-600">
                                Booking telah dikonfirmasi oleh admin.
                                Lapangan dianggap sudah dibayar.
                              </p>

                              {payment?.paymentDate && (
                                <p className="mt-2 text-xs text-emerald-600">
                                  Dibayar pada:{" "}
                                  {formatTanggal(payment.paymentDate)}
                                </p>
                              )}
                            </div>
                          )}
                          ...
                          {booking.status === "PENDING" && (
                            <div className="mt-4 rounded-xl border border-orange-100 bg-orange-50 p-4">
                              ...
                              <p className="mt-2 text-xs leading-5 text-orange-600">
                                Silakan tunggu sampai admin mengonfirmasi
                                booking kamu.
                              </p>
                            </div>
                          )}
                          ...
                          {booking.status === "CANCELLED" && (
                            <div className="mt-4 rounded-xl border border-red-100 bg-red-50 p-4">
                              ...
                              <p className="mt-2 text-xs leading-5 text-red-600">
                                Booking lapangan ini telah dibatalkan oleh
                                admin.
                              </p>
                            </div>
                          )}
                    ...
                    <div className="flex flex-col justify-between gap-3 border-t border-slate-100 bg-slate-50/50 px-7 py-5 sm:flex-row sm:items-center">
                      <p className="text-sm text-slate-500">
                        ...
                        <span className="font-medium text-slate-700">
                          {formatTanggal(booking.createdAt)}
                        </span>
                      </p>
